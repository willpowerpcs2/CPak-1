...
const NewMerchant = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      ...
      setSnackbar({
        open: true,
        message: `Merchant "${formData.name}" has been successfully added`,
        severity: 'success'
      });
    ...
    // try {
    //   const response = await axios.post('/api/merchants', formData);
    //   setSnackbar({
    //     open: true,
    //     message: `Merchant "${formData.name}" has been successfully added`,
    //     severity: 'success'
    ...
    //   setSnackbar({
    //     open: true,
    //     message: 'Failed to add merchant. Please try again.',
    //     severity: 'error'
    //   });
    //   setSubmitting(false);
    // }
